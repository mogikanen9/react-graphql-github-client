...
const DEFAULT_ORG_NAME = "spring-projects";
...
class Router extends React.Component<IRouterProps, IRouterState>{
    ...
    constructor(props: IRouterProps) {
        ...
        this.state = {
            ...
            repositories: [],
            selectedOrgName: DEFAULT_ORG_NAME
        }
    ...
    public componentDidMount() {
        this.loadRepo(this.state.selectedOrgName);
    }
    ...
    protected loadRepo(orgName: string): void {
        this.setState({ isLoading: true });
        this.props.clientService.listRepos(orgName, DEFAULT_PAGE_SIZE)
        ...
        this.setState(
                    {
                        repoPagination: EMPTY_REPO_PAGINATION,
                        repositories: [],
                        selectedOrgName: newOrgName,
                    });
        this.loadRepo(newOrgName);
    }
    ...
    protected repoPage(pageSize: number, paginationCursor: string, forward: boolean): void {
        this.setState({ isLoading: true });
        this.props.clientService.listRepos(this.state.selectedOrgName, pageSize, paginationCursor)
            .then((result: RepositoryResultList) => {
                const pageCursors = this.state.repoPagination.pageCursors;
